...
def create_yolov3_modules(n_classes, ignore_thre):
    """
    Build yolov3 layer modules.
    Args:
        n_classes (int): number of object categories.
...
class YOLOv3(nn.Module):
    ...
    """
    def __init__(self, n_classes, ignore_thre=0.7):
        """
        ...
        self.module_list = create_yolov3_modules(n_classes, ignore_thre)
